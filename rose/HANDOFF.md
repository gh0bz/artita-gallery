# Artita Gallery — “Rosé” direction

Blush editorial · three-up grid hero
...
This is one of three sibling directions; this folder is everything needed to host **Rosé** on its own.
...
| File | What it is |
|------|------------|
| `index.html` | Entry point. Loads fonts, the stylesheet, the data, and the app. The `<body>` carries the theme class `theme-C`. |
...
Open **`styles.css`** and edit the `.theme-C` token block near the top
