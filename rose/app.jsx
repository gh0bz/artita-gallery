...
(function () {
  ...
  function Home({ go }) {
    return (<React.Fragment>
      ...
      <HeroGrid onShop={go.shop} />
      <ProductGrid eyebrow="The edit" title="Most loved" link="Shop all" onOpen={go.open} items={D.PRODUCTS.slice(0, 3)} cols={3} />
      <Categories />
      <Editorial img={D.EDITORIAL.wide} eyebrow="The lookbook" title="A softer kind of luxury." body="Warm gold against bare skin, captured in natural light. Discover the pieces behind the campaign." cta="See the lookbook" onShop={go.shop} />
      <About flip />
      <Difference />
      <Reviews />
      <Instagram />
