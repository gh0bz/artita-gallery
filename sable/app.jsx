...
(function () {
  ...
  function Home({ go }) {
    return (<React.Fragment>
      ...
      <HeroFull onShop={go.shop} onPdp={go.pdp} />
      <Categories />
      <ProductGrid eyebrow="The edit" title="Featured pieces" link="Shop all" onOpen={go.open} items={D.PRODUCTS.slice(0, 3)} cols={3} />
      <About />
      <Difference />
      <Editorial img={D.EDITORIAL.blush} eyebrow="The edit" title="Six pieces. Endless ways to wear them." body="Rings, necklaces and everyday diamonds designed to layer, stack and live together — explore the full collection." cta="Shop the collection" onShop={go.shop} />
      <Reviews />
      <Instagram />
      <Newsletter />
      <Footer logo={LOGO} />
