# Artita Gallery — “Sable” direction

Warm nude · full-bleed editorial hero
...
This is one of three sibling directions; this folder is everything needed to host **Sable** on its own.
...
| File | What it is |
|------|------------|
| `index.html` | Entry point. Loads fonts, the stylesheet, the data, and the app. The `<body>` carries the theme class `theme-A`. |
...
Open **`styles.css`** and edit the `.theme-A` token block near the top
